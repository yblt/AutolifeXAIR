...
未独立复测。held_feedback_center 189 / held_feedback_tolerance 8 为 2026-08-22
左爪持瓶实测值（抓取时 185.4–190.4，导航到点 3 后 193.3；右爪值 200±5 会拒绝执行）。
y_align_x_m 0.60（>悬停 x，即先伸到悬停 x 再横挪）为 2026-08-22 左臂投右篮（跨中线，
目标 y≈-0.05）的现场值：在 0.35 处横挪时左大臂在 y=0.106 触发 daemon 自碰撞；
向中线可达余量随前伸量约 0.8:1 增长（用户决策路线 B）。
hover_offset_m X -0.32（右臂 -0.27 再后退 5 cm）：2026-08-22 run 20260822T030600Z 投放成功
但瓶身擦着篮壁过去，操作者现场判断后退 5 cm。
"""
